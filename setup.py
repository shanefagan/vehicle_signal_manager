...
setup(
    ...
    # Author details
    author='Shane Fagan',
    author_email='shane.fagan@collabora.com',
    ...
    classifiers=[
        ...
        'Topic :: Software Development :: Application Development',

        # Pick your license as you wish (should match "license" above)
        'License :: OSI Approved :: MPLv2 License',
    ...
    keywords='policy-manager vehicle development',
